...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Asset duplicatedAsset = contract.DuplicateAsset(ctx, "asset1", "John");

            assertThat(duplicatedAsset).isEqualTo(new Asset("asset1-duplicate", "blue", 45, "John", 60));
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "John");
            });
